...
const worker=new Worker(new URL('./slam-worker-build-20260925-24.js?v=20260925.24',import.meta.url),{type:'classic'});
...
log('INFO',`Build=20260925.24 · near-keyframe T265 map identity`);
