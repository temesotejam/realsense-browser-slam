...
const worker=new Worker(new URL('./slam-worker-build-20260925-26.js?v=20260925.26',import.meta.url),{type:'classic'});
...
log('INFO',`Build=20260925.26 · STATIC map relock`);
