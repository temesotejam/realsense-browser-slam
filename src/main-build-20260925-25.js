...
const worker=new Worker(new URL('./slam-worker-build-20260925-25.js?v=20260925.25',import.meta.url),{type:'classic'});
...
log('INFO',`Build=20260925.25 · T265-cumulative STATIC gate`);
