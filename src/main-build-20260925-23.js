...
const worker=new Worker(new URL('./slam-worker-build-20260925-23.js?v=20260925.23',import.meta.url),{type:'classic'});
...
log('INFO',`Build=20260925.23 · T265-seeded map matching`);
